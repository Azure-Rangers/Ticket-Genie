...
def generate_ticket_pdf(ticket_id: str) -> bytes:
    ...
    try:
        ...
        elements.append(Paragraph(f"Document Generated for Ticket ID: <b>{ticket['id']}</b>", subtitle_style))
...
def generate_ticket_docx(ticket_id: str) -> bytes:
    ...
    ticket = get_ticket_by_id(ticket_id) or {"id": ticket_id, "title": "Ticket Summary", "status": "Open", "department": "IT"}
